...
static GUID IID_IMediaControl = {0x56a868b1, 0x0ad4, 0x11ce, 0xb0, 0x3a, 0x00,
                                 0x20,       0xaf,   0x0b,   0xa7, 0x70};
static GUID CLSID_FilterGraph = {0xe436ebb3, 0x524f, 0x11ce, 0x9f, 0x53, 0x00,
                                 0x20,       0xaf,   0x0b,   0xa7, 0x70};
static GUID IID_IGraphBuilder = {0x56a868a9, 0x0ad4, 0x11ce, 0xb0, 0x3a, 0x00,
                                 0x20,       0xaf,   0x0b,   0xa7, 0x70};
...
- initWithContentsOfFile: (NSString *) path byReference: (BOOL) byReference {
    ...
    if (SUCCEEDED(CoCreateInstance(&CLSID_FilterGraph, NULL,
        ...
        if (_graphBuilder != NULL) {
            ...
            HRESULT hr = _graphBuilder->lpVtbl->RenderFile(_graphBuilder,
                                                           soundPathW, NULL);
            if (!SUCCEEDED(hr)) {
                [self dealloc];
                return nil;
