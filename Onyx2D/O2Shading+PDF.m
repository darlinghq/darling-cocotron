...
- (O2PDFObject *) encodeReferenceWithContext: (O2PDFContext *) context {
    ...
    [result setObjectForKey: "ColorSpace"
                      value: [_colorSpace encodeReferenceWithContext: context]];

    [result setObjectForKey: "Coords"
                      value: [O2PDFArray pdfArrayWithNumbers: coords
                                                       count: coordsCount]];

    [result setObjectForKey: "Domain"
                      value: [O2PDFArray pdfArrayWithNumbers: _domain
                                                       count: 2]];
    [result setObjectForKey: "Function"
                      value: [_function encodeReferenceWithContext: context]];
...
O2Shading *axialShading(O2PDFDictionary *dictionary,
    ...
    if ((function = [O2Function createFunctionWithDictionary: fnDictionary]) ==
        NULL) {
        return NULL;
    }
